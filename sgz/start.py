...
def get_distance():
    point_infos = find_pic_num_confidence(picpath + r"\mucai.png",200,0.8)
    print("mucai :",point_infos)
    if point_infos != None:
        find_click(point_infos)
        time.sleep(2)
    point_infos = find_pic_num_confidence(picpath + r"\zhongxiny.png",200,0.8)
...
def start_sgzapp():
    ...
    # 找到启动按钮
    point_infos = find_pic(picpath + r"\start.png")
    ...
    # time.sleep(20)
    # 查找sgz_app并启动
    point_infos = find_pic(picpath + r"\sgz_app.png")
    print("sgz_app is :",point_infos)
    find_click(point_infos)
    time.sleep(40)
    # 选择点击进入
    point_infos = find_pic(picpath + r"\dian.png")
...
def new_role():
    ...
    num = 0
    while True:
        point_infos = find_pic_num_confidence(picpath + r"\new_role_next.png",200,0.8)
        ...
        if point_infos != None:
            ...
            print("num is: ",num)
            if num >= 7 :
                point_infos = find_pic_num_confidence(picpath + r"\1_5.png",30,0.8)
    ...
    while True:
        for i in range(2):
            ...
            if point_infos != None:
                find_click(point_infos)
                time.sleep(2)
        point_infos = find_pic_num_confidence(picpath + r"\quedingxuanze.png",200,0.8)
        ...
        if point_infos != None:
            ...
            break
    while True:
        point_infos = find_pic_num_confidence(picpath + r"\jinruluanshi.png",200,0.8)
        print("jinruluanshi :",point_infos)
        if point_infos != None:
            find_click(point_infos)
            point_infos = find_pic_num_confidence(picpath + r"\qingchongxinshuru.png",50,0.8)
            print("qingchongxinshuru :",point_infos)
            if point_infos != None:
                point_infos = find_pic_num_confidence(picpath + r"\suiji.png",30,0.8)
                if point_infos != None:
    ...
    while True:
        for i in range(5):
            ...
            if point_infos != None:
                find_click(point_infos)
                time.sleep(5)
        point_infos = find_pic_num_confidence(picpath + r"\jiangdong.png",50,0.8)
        print("jiangdong :",point_infos)
        if point_infos != None:
            find_click(point_infos)
            time.sleep(1)
            break
    point_infos = find_pic_num_confidence(picpath + r"\ruzhu.png",200,0.8)
    print("ruzhu :",point_infos)
    if point_infos != None:
        find_click(point_infos)
        time.sleep(40)
        while True:
            point_infos = find_pic_num_confidence(picpath + r"\jinruchangjingzhong.png",100,0.8)
            ...
            if point_infos != None:
                ...
                break
    point_infos = find_pic_num_confidence(picpath + r"\xiayibu.png",200,0.8)
    ...
    while True:
        ...
        point_infos = find_pic_num_confidence(picpath + r"\zhaomu_wuhong.png",50,0.8)
    ...
    if point_infos != None:
        find_click(point_infos)
        time.sleep(2)    
    point_infos = find_pic_num_confidence(picpath + r"\xuanzezhucheng.png",200,0.8)
    print("xuanzezhucheng :",point_infos)
    if point_infos != None:
        find_click(point_infos)
        time.sleep(2)
    point_infos = find_pic_num_confidence(picpath + r"\rucheng.png",200,0.8)
    print("rucheng :",point_infos)
    if point_infos != None:
        find_click(point_infos)
        time.sleep(2)    
    point_infos = find_pic_num_confidence(picpath + r"\dianjibianzhibudui.png",200,0.8)
    ...
    for i in range(2):
        point_infos = find_pic_num_confidence(picpath + r"\peizhiwujiang.png",200,0.8)
        print("peizhiwujiang :",point_infos)
        if point_infos != None:
            find_click(point_infos)
            time.sleep(2)         
        point_infos = find_pic_num_confidence(picpath + r"\shangzhen.png",200,0.8)
        print("shangzhen :",point_infos)
        if point_infos != None:
            find_click(point_infos)
            time.sleep(2)       
    point_infos = find_pic_num_confidence(picpath + r"\kuaisufenbing.png",200,0.8)
    print("kuaisufenbing :",point_infos)
    if point_infos != None:
        find_click(point_infos)
        time.sleep(2)
    point_infos = find_pic_num_confidence(picpath + r"\querenfenbing.png",200,0.8)
    print("querenfenbing :",point_infos)
    if point_infos != None:
        find_click(point_infos)
        time.sleep(2)

    point_infos = find_pic_num_confidence(picpath + r"\fanhui.png",200,0.8)
    print("fanhui :",point_infos)
    if point_infos != None:
        find_click(point_infos)
        time.sleep(2)
    point_infos = find_pic_num_confidence(picpath + r"\fanhui_2.png",200,0.8)
    ...
    if point_infos != None:
        ...
        pyautogui.moveTo(1,1,duration=0.3)
        time.sleep(2)   
    point_infos = find_pic_num_confidence(picpath + r"\gongzhan.png",200,0.8)
    print("gongzhan :",point_infos)
    if point_infos != None:
        find_click(point_infos)
        time.sleep(2)
    point_infos = find_pic_num_confidence(picpath + r"\daiming.png",200,0.8)
    print("daiming :",point_infos)
    if point_infos != None:
        find_click(point_infos)
        time.sleep(2)
    point_infos = find_pic_num_confidence(picpath + r"\gongzhan_2.png",200,0.8)
    print("gongzhan_2 :",point_infos)
    if point_infos != None:
        find_click(point_infos)
        time.sleep(25)
        # 攻占后如果等待100秒，可以不点击跳过按钮
        point_infos = find_pic_num_confidence(picpath + r"\tiaoguo.png",200,0.8)
    ...
    point_infos = find_pic_num_confidence(picpath + r"\qushou.png",200,0.8)
    ...
    if point_infos != None:
        ...
        time.sleep(3)
        # # 查看文字取首与资源图标top的间隔距离
        # point_infos = find_pic_num_confidence(picpath + r"\ziyuan.png",200,0.8)
    ...
    while True:
        for i in range(2):
            ...
            if point_infos != None:
                find_click(point_infos)
                time.sleep(2)
        point_infos = find_pic_num_confidence(picpath + r"\huicheng.png",200,0.8)
    ...
    while True:
        for i in range(10):
            ...
            if i == 4:
                time.sleep(16)
        point_infos = find_pic_num_confidence(picpath + r"\xuanzezhucheng.png",30,0.8)
        print("xuanzezhucheng :",point_infos)
        if point_infos != None:
            find_click(point_infos)
            time.sleep(2)
    ...
    if point_infos != None:
        find_click(point_infos)
        time.sleep(2)  
    point_infos = find_pic_num_confidence(picpath + r"\bingzhongqibing.png",200,0.8)
    print("bingzhongqibing :",point_infos)
    if point_infos != None:
        find_click(point_infos)
        time.sleep(2)  
    point_infos = find_pic_num_confidence(picpath + r"\bingzhongxuanze.png",200,0.8)
    print("bingzhongxuanze :",point_infos)
    if point_infos != None:
        find_click(point_infos)
        time.sleep(2)      
    point_infos = find_pic_num_confidence(picpath + r"\qiangbing.png",200,0.8)
    ...
    if point_infos != None:
        find_click(point_infos)
        time.sleep(2)    
    point_infos = find_pic_num_confidence(picpath + r"\xuanzemubiaolingdi.png",200,0.8)
    ...
    # point_infos = find_pic_num_confidence(picpath + r"\yijun.png",200,0.8)
    # print("yijun  :",point_infos)
    point_infos = find_pic_num_confidence(picpath + r"\xingjun.png",200,0.8)
    ...
    if point_infos != None:
        find_click(point_infos)
        time.sleep(2)
    point_infos = find_pic_num_confidence(picpath + r"\xingjun_2.png",200,0.8)
    print("xingjun_2 yuan :",point_infos)
    if point_infos != None:
        find_click(point_infos)
        time.sleep(20)
        # 攻占后如果等待100秒，可以不点击跳过按钮
        point_infos = find_pic_num_confidence(picpath + r"\tiaoguo.png",50,0.8)
        print("tiaoguo  :",point_infos)
        if point_infos != None:
            find_click(point_infos)
            time.sleep(20)
    ...
    while True:
        for i in range(4):
            ...
            if point_infos != None:
                find_click(point_infos)
                time.sleep(2)    
        point_infos = find_pic_num_confidence(picpath + r"\zhaocheng_dianjifanhui.png",200,0.8)
    ...
    while True:
        ...
        point_infos = find_pic_num_confidence(picpath + r"\xuanzezhucheng.png",100,0.8)
        print("xuanzezhucheng :",point_infos)
        if point_infos != None:
            find_click(point_infos)
            time.sleep(2)
    ...
    point_infos = find_pic_num_confidence(picpath + r"\bingzhongqiangbing.png",200,0.8)
    print("bingzhongqiangbing :",point_infos)
    if point_infos != None:
        find_click(point_infos)
        time.sleep(2)  
    point_infos = find_pic_num_confidence(picpath + r"\xiazhen.png",200,0.8)
    print("xiazhen :",point_infos)
    if point_infos != None:
        find_click(point_infos)
        time.sleep(2)  
    point_infos = find_pic_num_confidence(picpath + r"\queren.png",200,0.8)
    print("queren :",point_infos)
    if point_infos != None:
        find_click(point_infos)
        time.sleep(2)  
    point_infos = find_pic_num_confidence(picpath + r"\peizhiwujiang_jiahao.png",200,0.8)
    ...
    while True:
        for i in range(4):
            ...
            if point_infos != None:
                ...
                time.sleep(3)
        time.sleep(5)
        point_infos = find_pic_num_confidence(picpath + r"\yimunanfu.png",200,0.8)
    ...
    point_infos = find_pic_num_confidence(picpath + r"\qianwangjiaru_tongmeng.png",30,0.8)
    print("qianwangjiaru_tongmeng :",point_infos)
    if point_infos != None:
        find_click(point_infos)
        time.sleep(2)
        point_infos = find_pic_num_confidence(picpath + r"\shenqingjiaru_tongmeng.png",30,0.8)
        print("shenqingjiaru_tongmeng :",point_infos)
        if point_infos != None:
            find_click(point_infos)
            time.sleep(2)
            point_infos = find_pic_num_confidence(picpath + r"\fanhui_2.png",30,0.8)
            print("fanhui_2 :",point_infos)
            if point_infos != None:
                find_click(point_infos)
                time.sleep(2)   
    point_infos = find_pic_num_confidence(picpath + r"\queren.png",30,0.8)
    print("queren :",point_infos)
    if point_infos != None:
        find_click(point_infos)
        time.sleep(2)
...
def answer_quest():
    ...
    while True:
        ...
        point_infos = find_pic_num_confidence(picpath + r"\2_5.png",30,0.8)
        ...
        point_infos = find_pic_num_confidence(picpath + r"\3_5.png",30,0.8)
        ...
        point_infos = find_pic_num_confidence(picpath + r"\4_5.png",30,0.8)
        ...
        point_infos = find_pic_num_confidence(picpath + r"\5_5.png",30,0.8)
...
def qianwang():
    # 选择前往征战
    point_infos = find_pic(picpath + r"\qianwang.png")
...
def find_pic_old(picture_path):
    # grayscale 是否转灰度
    # point_info = pyautogui.locateCenterOnScreen(picpath + r"\txsp.png",grayscale=True)
    i = 1
    while True:
        point_info = pyautogui.locateOnScreen(picture_path,confidence=0.8)
...
def zhaomu_shouci():
    point_infos = find_pic_num_confidence(picpath + r"\zhaomu_wuhong.png",200,0.8)
    print("zhaomu_wuhong :",point_infos)
    if point_infos != None:
        find_click(point_infos)
        time.sleep(3)
        point_infos = find_pic_num_confidence(picpath + r"\mingjiang_hong.png",200,0.8)
        # point_infos = find_pic_10(picpath + r"\pk_mingjiang.png")
        print("mingjiang_hong :",point_infos)
        if point_infos != None:
            find_click(point_infos)
            time.sleep(3)
            point_infos = find_pic_num_confidence(picpath + r"\zhaomu2_free.png",200,0.8)
...
def zhaomu():
    point_infos = find_pic_num_confidence(picpath + r"\zhaomu_hong.png",20,0.8)
    print("zhaomu_hong :",point_infos)
    if point_infos != None:
        find_click(point_infos)
        time.sleep(3)
        point_infos = find_pic_num_confidence(picpath + r"\mingjiang_hong.png",20,0.8)
        # point_infos = find_pic_10(picpath + r"\pk_mingjiang.png")
        print("mingjiang_hong :",point_infos)
        if point_infos != None:
            find_click(point_infos)
            time.sleep(3)
            point_infos = find_pic_num_confidence(picpath + r"\zhaomu1_free.png",20,0.8)
            print("zhaomu1_free :",point_infos)
            if point_infos != None:
                find_click(point_infos)
                time.sleep(3)
                zhaomu_cheng()
                point_infos = find_pic_num_confidence(picpath + r"\zhaomu1_half.png",20,0.8)
                print("zhaomu1_half :",point_infos)
                if point_infos != None:
                    find_click(point_infos)
                    time.sleep(1)
                    point_infos_buzu = find_pic_num_confidence(picpath + r"\jinzhubuzu.png",20,0.8)
...
def fanhui():
    for i in range(2):
        point_infos = find_pic_num_confidence(picpath + r"\fanhui.png",30,0.8)
        print("fanhui :",point_infos)
        if point_infos != None:
            find_click(point_infos)
            time.sleep(2)
...
def zhaomu_cheng():
    ...
    if point_infos != None:
        find_click(point_infos)
        time.sleep(3)
        point_infos = find_pic_num_confidence(picpath + r"\zhaocheng_dianjifanhui.png",50,0.8)
        print("点击其他区域返回 :",point_infos)
        if point_infos != None:
            find_click(point_infos)
            time.sleep(3)
    else:
        point_infos = find_pic_num_confidence(picpath + r"\fanhui.png",50,0.8)
        print("fanhui :",point_infos)
        if point_infos != None:
            find_click(point_infos)
            time.sleep(3)        
...
def dingwei_zhucheng():
    point_infos = find_pic(picpath + r"\dibiao1.png ")
    find_click(point_infos)
    # point_infos = find_pic(picpath + r"\zhucheng_dingwei.png ")
    ...
    pyautogui.moveTo(1,1,duration=0.3)
    time.sleep(2)
    point_infos = find_pic(picpath + r"\rucheng.png ")
    print("rucheng : ",point_infos )
    find_click(point_infos)
    time.sleep(2)
...
def chengjian():
    dingwei_zhucheng()
    point_infos = find_pic_num_confidence(picpath + r"\chengjian.png",20,0.8)
    if point_infos != None:
        find_click(point_infos)
        time.sleep(2)
    else:
        return
    for i in range(6):
        point_infos = find_pic_num_confidence(picpath + r"\sheng.png",20,0.9)
        print("sheng 可升级建设坐标 is: ",point_infos)
        if point_infos != None:
            find_click(point_infos)
        if point_infos != None:
            point_infos = find_pic_num_confidence(picpath + r"\shengji.png",20,0.8)
            if point_infos != None:
                find_click(point_infos)
            else:
                point_infos = find_pic_num_confidence(picpath + r"\jianzao.png",20,0.8)
                if point_infos != None:
                    find_click(point_infos)                
            point_infos = find_pic_num_confidence(picpath + r"\meiyouduilie.png",30,0.8)
            if point_infos != None:
                print("meiyouduilie")
                time.sleep(10)
                break
            point_infos = find_pic_num_confidence(picpath + r"\queren.png",20,0.8)
            if point_infos != None:
                find_click(point_infos)
                time.sleep(1)
        else:
            point_infos = find_pic_num_confidence(picpath + r"\junshi.png",20,0.8)
...
def get_zhucheng():
    point_infos = find_pic_num_confidence(picpath + r"\dibiao_zuobiao.png",20,0.8)
    ...
    if point_infos != None:
        ...
        im.save(picpath + r"\zuobiao_to_str.png")
        time.sleep(1)
        text = pytesseract.image_to_string(Image.open(picpath + r"\zuobiao_to_str.png"))
        print(text)
...
def kuaisu_fenbing(teamnum):
    ...
    for i in range(teamnum):
        ...
        time.sleep(2)
        point_infos = find_pic_num_confidence(picpath + r"\kuaisufenbing.png",30,0.9)
        print("kuaisufenbing :",point_infos)
        if point_infos != None:
            find_click(point_infos)
            time.sleep(2)
            point_infos_fenbing = find_pic_num_confidence(picpath + r"\querenfenbing.png",30,0.9)
...
def zhengbing():
    dingwei_zhucheng()
    cha_quxiao = find_pic_num_confidence(picpath + r"\cha_quxiaozhengbing.png",50,0.9)
    print("cha_quxiaozhengbing is: ",cha_quxiao)
    if cha_quxiao != None:
        find_click(cha_quxiao)
        time.sleep(1)
        queding = find_pic_num_confidence(picpath + r"\queding.png",50,0.9)
        print("queding is: ",queding)
        if queding != None:
            find_click(queding)
            time.sleep(1) 
    zhengbing = find_pic_num_confidence(picpath + r"\zhengbing.png",50,0.9)
    print("zhengbing is: ",zhengbing)
    if zhengbing != None:
        find_click(zhengbing)
        time.sleep(1)
        zuida = find_pic_num_confidence(picpath + r"\zuida.png",50,0.9)
        print("zuida is: ",zuida)
        if zuida != None:
            find_click(zuida)
            time.sleep(1)
            kaishizhengbing = find_pic_num_confidence(picpath + r"\kaishizhengbing.png",50,0.9)
            print("kaishizhengbing is: ",kaishizhengbing)
            if kaishizhengbing != None:
                find_click(kaishizhengbing)
                time.sleep(1)
                queren = find_pic_num_confidence(picpath + r"\queren.png",50,0.9)
...
def get_teamid():
    team_ids = []
    team_info = find_pic_num_confidence(picpath + r"\duiwu_1.png",50,0.9)
    ...
    if team_info != None:
        ...
        return team_ids
    team_info = find_pic_num_confidence(picpath + r"\duiwu_2.png",50,0.9)
    print("team_2 is: ",team_info)
    if team_info != None:
        team_ids.append(team_info)
    else:
        return team_ids
    team_info = find_pic_num_confidence(picpath + r"\duiwu_3.png",50,0.9)
    print("team_3 is: ",team_info)
    if team_info != None:
        team_ids.append(team_info)
    else:
        return team_ids
    team_info = find_pic_num_confidence(picpath + r"\duiwu_4.png",50,0.9)
    print("team_4 is: ",team_info)
    if team_info != None:
        team_ids.append(team_info)
    else:
        return team_ids
    team_info = find_pic_num_confidence(picpath + r"\duiwu_5.png",50,0.9)
...
def toxy(x,y):
    print("toxy x,y: ",x,y)
    ditu = find_pic_num_confidence(picpath + r"\ditu.png",50,0.8)
    if ditu != None:
        find_click(ditu)
        time.sleep(2)
        # 根据 坐标输入框前的“坐标图标“ 计算坐标偏移量x y
        zuobiao_biaoshi = find_pic_num_confidence(picpath + r"\zuobiao_biaoshi.png",50,0.9)
        if zuobiao_biaoshi != None:
            ...
            start_mnq(dest_node[0], dest_node[1])
            time.sleep(2)
            wancheng = find_pic_num_confidence(picpath + r"\wancheng.png",50,0.8)
            if wancheng != None:
                ...
                pyautogui.mouseUp()
                time.sleep(1)
                quanxuan = find_pic_num_confidence(picpath + r"\quanxuan.png",50,0.8)
                if quanxuan != None:
            ...
            if wancheng != None:
                ...
                find_click(wancheng)
                qianwang_xy = find_pic_num_confidence(picpath + r"\qianwang_xy.png",50,0.9)
                if qianwang_xy != None:
...
def get_landinfo(x,y):
    ...
    # pointinfo = find_pic_num_confidence(picpath + r"\kongdi.png",50,0.8)
    # pointinfo = find_pic_num_confidence(picpath + r"\1ji.png",50,0.8)
    # pointinfo = find_pic_num_confidence(picpath + r"\2ji.png",50,0.8)
    # pointinfo = find_pic_num_confidence(picpath + r"\3ji.png",50,0.8)
    # pointinfo = find_pic_num_confidence(picpath + r"\4ji.png",50,0.8)
    # pointinfo = find_pic_num_confidence(picpath + r"\5ji.png",50,0.8)
    # pointinfo = find_pic_num_confidence(picpath + r"\6ji.png",50,0.8)
    # pointinfo = find_pic_num_confidence(picpath + r"\7ji.png",50,0.8)
    # pointinfo = find_pic_num_confidence(picpath + r"\8ji.png",50,0.8)
    ...
    dibiao_zuobiao = find_pic_num_confidence(picpath + r"\dibiao1.png",20,0.8)
    print("dibiao is: ",dibiao_zuobiao)
    # pyautogui.moveTo(dibiao_zuobiao.left,dibiao_zuobiao.top)
    time.sleep(2)
    # # 地块信息 todo landinfo 待确认位置
    # landinfo = find_pic_num_confidence(picpath + r"\landinfo.png",20,0.8)
    ...
    tmp_shot.save(picpath + r"\tmp_shot.png")
    time.sleep(1)
    ...
    # text = pytesseract.image_to_string(Image.open(picpath + r"\tmp_shot.png"))
    # result = my_ocr(picpath + r"\tmp_shot.png")
    ...
    you = find_pic_num_confidence(picpath + r"\you.png",10,0.8)
    if you != None:
        who_lock = 3
        print("you is: ",you)
    # if land_type != 6:
    else:
        lvse_zhugong = find_pic_num_confidence(picpath + r"\lvse_zhugong.png",10,0.9)
        if lvse_zhugong != None:
            who_lock = 1
            print("lvse_zhugong is: ",lvse_zhugong)
        else:
            lanse_zhugong = find_pic_num_confidence(picpath + r"\lanse_zhugong.png",10,0.9)
            if lanse_zhugong != None:
                who_lock = 2
                print("lanse_zhugong is: ",lanse_zhugong)
            else:
                qianlan_zhugong = find_pic_num_confidence(picpath + r"\qianlan_zhugong.png",10,0.8)
                if qianlan_zhugong != None:
                    who_lock = 3
                    print("qianlan_zhugong is: ",qianlan_zhugong)
                else:
                    hongse_zhugong = find_pic_num_confidence(picpath + r"\hongse_zhugong.png",10,0.8)
...
def saodang(team_id,x,y):
    toxy(x,y)
    time.sleep(2)
    saodang = find_pic_num_confidence(picpath + r"\saodang.png",50,0.8)
    if saodang != None:
        find_click(saodang)
        time.sleep(2)
        xuanzebudui = find_pic_num_confidence(picpath + r"\xuanzebudui.png",50,0.7)
        if xuanzebudui != None:
            print("xuanzebudui: ",xuanzebudui)
            time.sleep(2)
            # 获取5个队伍时 绿色"待命"与 "选择部队" 的偏移量
            daimings = find_pic_list(picpath + r"\daiming_5dui.png",0.7)
            ...
            point_infos = find_pic_num_confidence(picpath + r"\zanshiwufaxingdong.png",50,0.7)
            if point_infos != None:
                print("zanshiwufaxingdong: ",point_infos)
                fanhui_1()
                return

            point_infos = find_pic_num_confidence(picpath + r"\saodang_2.png",50,0.7)
            if point_infos != None:
                print("saodang_2: ",point_infos)
                find_click(point_infos)
                point_infos = find_pic_num_confidence(picpath + r"\jianchichuzheng.png",50,0.7)
                if point_infos != None:
